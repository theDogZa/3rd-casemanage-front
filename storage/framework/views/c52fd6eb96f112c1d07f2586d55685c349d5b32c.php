                ...
                <div class="sidebar-content">
                    ...
                    <div class="content-side content-side-full content-side-user px-10 align-parent">
                        ...
                        <div class="sidebar-mini-hidden-b text-center">
                            <a class="img-link" href="javascript:void(0)">
                                <img class="img-avatar" src="<?php echo e(asset('media/avatars/avatar15.jpg')); ?>" alt="">
                            </a>
                    ...
                    <div class="content-side content-side-full">
                        <ul class="nav-main">
                            ...
                            <li class="<?php echo e(request()->is('examples/*') ? ' open' : ''); ?>">
                                <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-bulb"></i><span class="sidebar-mini-hide">Examples</span></a>
                                <ul>
                                    <li>
                                        <a class="<?php echo e(request()->is('examples/plugin') ? ' active' : ''); ?>" href="/examples/plugin">Plugin</a>
                                    </li>
                                    <li>
                                        <a class="<?php echo e(request()->is('examples/blank') ? ' active' : ''); ?>" href="/examples/blank">Blank</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nav-main-heading">
